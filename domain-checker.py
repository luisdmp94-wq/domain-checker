...
def main():
    ...
    report = {
        ...
        "codigo_fuente": source_code, "js_files": js_findings, "shodan": shodan_info, "email_spoofing": email_spoofing, "server_info": server_info, "subdomain_takeover": takeover, "cves": cves, "open_redirects": open_redirects, "csrf": csrf, "subdomain_headers": subdomain_headers, "exposed_paths": exposed_paths, "api_endpoints": api_endpoints, "risk_score": risk_score
    }
